...
console.log("1. Sorted by skills",_.sortBy(_.uniq(_.flatten(_.map(data,'skills')))));

 console.log('2. Sorted by friends',_.sortBy(_.map(_.orderBy(data, 'friends.length'), 'name')));

console.log("3. Massive of uniq friends", _.uniq(_.map(_.flatten(_.map(data,'friends')),'name')));
 });
